const AboutContent = () => {
    return (
        <section className="w-full max-w-3xl mx-auto p-6 bg-black text-gray-300">
            ...
            <p className="mb-4">
                When I’m not coding, you’ll find me cycling through the city streets, sketching thoughts that refuse to stay on paper, playing chess, or just sipping coffee and dreaming up what’s next.
            </p>
            <p>
